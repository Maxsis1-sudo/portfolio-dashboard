...
setTimeout(()=>{
  ...
  /* Put the three most important actions immediately in front of guests. */
  if(!document.getElementById('priorityActions')){
    const style=document.createElement('style');
    style.textContent=`
      .priority-actions{position:relative;z-index:6;margin:-22px auto 12px;padding:0 12px}
      .priority-panel{background:rgba(255,253,251,.96);border:1px solid var(--line);border-radius:26px;padding:16px;box-shadow:0 14px 35px rgba(70,45,35,.14);backdrop-filter:blur(14px)}
      ...
      @media(max-width:520px){.priority-actions{margin-top:-17px}.priority-panel{padding:12px;border-radius:22px}.priority-grid{gap:7px}.priority-card{min-height:104px;padding:13px 6px;border-radius:17px}.priority-card .pi{font-size:28px}.priority-card strong{font-size:13px}.priority-card small{font-size:8px}.priority-title b{font-size:23px}}
    `;
